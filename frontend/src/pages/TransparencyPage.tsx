    ...
    return (
        <VStack spacing={6} maxW="6xl" mx="auto">
            ...
            <Card w="full" bg="purple.50" borderTop="4px" borderColor="purple.500">
                <CardBody>
                    <Heading size="md" mb={4} color="purple.900">Fairness Metrics by Device Type</Heading>
                    ...
                    <Text fontSize="xs" color="gray.800" mt={4}>
            ...
            <Card w="full" bg="blue.50" borderTop="4px" borderColor="blue.500">
                <CardBody>
                    <Heading size="md" mb={4} color="blue.900">Bias Audit Report</Heading>
                    <VStack align="stretch" spacing={3}>
                        <HStack justify="space-between">
                            <Text fontWeight="medium" color="gray.800">Last Audit Date:</Text>
                            <Text color="gray.800">November 10, 2025</Text>
                        </HStack>
                        <HStack justify="space-between">
                            <Text fontWeight="medium" color="gray.800">Demographic Parity:</Text>
                            <Badge colorScheme="green">PASS (0.97)</Badge>
                        </HStack>
                        <HStack justify="space-between">
                            <Text fontWeight="medium" color="gray.800">Equal Opportunity:</Text>
                            <Badge colorScheme="green">PASS (0.95)</Badge>
                        </HStack>
                        <HStack justify="space-between">
                            <Text fontWeight="medium" color="gray.800">Disparate Impact Ratio:</Text>
                            <Badge colorScheme="green">PASS (0.89)</Badge>
                        </HStack>
                        <Text fontSize="sm" color="gray.800" pt={2}>
